...
class PrsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        mixer.blend(Organisation, name="Western Australian Planning Commission", slug="wapc")
        ...
        mixer.blend(ReferralType, name="Development application", slug="development-application")
...
class NoteTest(PrsTestCase):
    ...
    def test_as_tbody(self):
        ...
        n = Note.objects.first()
        body = n.as_tbody()
        self.assertIsNot(body.find(n.note), -1)
        # Change some field values, for coverage.
        n.order_date = date.today()
        n.save()
        body = n.as_tbody()
